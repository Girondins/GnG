...
public class TapBarMenu extends LinearLayout {
    ...
    private void setupAttributes(AttributeSet attrs) {
        ...
        buttonSize = typedArray.getDimensionPixelSize(R.styleable.TapBarMenu_tbm_buttonSize, getResources().getDimensionPixelSize(com.michaldrabik.tapbarmenulib.R.dimen.defaultButtonSize));
